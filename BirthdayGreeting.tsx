...
const messages = [
  "✿ Hie cutie🎀, its your birthday my love 🧸✿",
  "Happy birthday to my dearest person, mi amor ᓚ₍⑅^..^₎♡. The gentleman ♛, my (unoffcial) husband🤭",
  "It's my kuchupu's special day >⩊< so, here's all i could do ִֶָ𓂃 ࣪˖ ִֶָ🐇་༘࿐",
  "kya aap dekhna chahoge?🥺(naa maat likhio, pit jaoge ૮₍'˶• . • ⑅ ₎ა)"
];
